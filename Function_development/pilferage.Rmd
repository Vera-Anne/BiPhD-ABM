...
I've done the following models (made changes + singular test run + environmental test run): 
...
Next I want to get 1.3.1 running on the HPC so I can start putting jobs through. 
