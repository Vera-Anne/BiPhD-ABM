...
p<-ggplot(df_psych_sum %>% filter((id == "fat_res" | id == "stom_con" | id == "fat_loss_r"), (model_type == "11" | model_type == "12" | model_type =="131" |model_type == "132"), (env == 8 | env == 6), timestep_within_day<=72), 
...
# Save the plot with specified size and resolution
ggsave("ch6_surv.png", plot = p, width = 7, height = 4.5, dpi = 500)  # Specify the size in inches and resolution
