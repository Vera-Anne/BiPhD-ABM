...
mod_1_1_hpc<-function(days, N, env_type, th_forage_sc, daylight_h){
  ...
  # This needs to be deleted for the hpc, the working directory would crash it. 
          # setwd("C:/Local_R/BiPhD-ABM/May23")
          # source('MOD_1_FuncSource.R')
