...
######################################################################
      ...
      # model 1.3 
      mod_1_3<-function(days, N, env_type, th_forage_sc1, th_forage_sc2, th_forage_sc3, daylight_h){
        ...
        outcome_1_3<- foreach(icount(N), .packages = "truncnorm", .combine='rbind') %do% {
        ...
        #return(outcome_1_1)
        assign(paste0('outcome_1_3_env', env_type),outcome_1_3, envir=.GlobalEnv)
        
        create_df_func(outputFile = outcome_1_3, modelType = '13', env_type= env_type)
      ...
      # The environment loop 
      env_func_1_3<-function(days, N, th_forage_sc1, th_forage_sc2, th_forage_sc3, daylight_h, modelType){
        ...
        for (env in 1:18){
          ...
          mod_1_3(days = days, N = N, env_type = env, th_forage_sc1 = th_forage_sc1, th_forage_sc2 = th_forage_sc2, th_forage_sc3 = th_forage_sc3, daylight_h = daylight_h)
