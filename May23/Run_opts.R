...
if (modelType==11){
  ...
  # Run The optimization for model 1.1 and its thresholds 
    ...
    # Set the number of options for which each trheshold needs to be tested 
      ...
      persp3D(z=ES_matrix, xlab='th_sc1', ylab='th_sc2', zlab='survival', main='Optimal survival for th_sc1 and th_sc2 - End Survival', zlim= c(0, 1))
      
      persp3D(z=HL_matrix, xlab='th_sc1', ylab='th_sc2', zlab='Timesteps at 50% alive', main='Optimal survival for th_sc1 and th_sc2 - Halflife', zlim= c(0, (days*72)))
