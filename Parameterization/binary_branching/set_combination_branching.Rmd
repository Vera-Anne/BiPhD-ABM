...
# level 1 
th1<-as.numeric(names(outcome_11))
th2<-as.numeric(names(outcome_11))

level_1<-expand.grid(th1, th2)
level_1<-level_1[level_1$Var1>level_1$Var2,]


# level 2 
th1<-c(as.numeric(names(outcome_11[[1]])), as.numeric(names(outcome_11[[2]])), as.numeric(names(outcome_11[[3]])), as.numeric(names(outcome_11[[4]])))
th2<-th1

level_2<-expand.grid(th1, th2)
level_2<-level_2[level_2$Var1>level_2$Var2,]
      ...
      for (i in 1:4){
        ...
        # Run the model 25 times in the 12 environments and take the average
          for (j in 1:25){
            ...
            # Run the model 
              if(model_type==11){
                env_func_1_1_par(days = 10, N= 100, th_forage_sc = cur_th, daylight_h = 8, modelType = 11)
              }else if(model_type==21){
                env_func_2_1_par(days = 10, N= 100, th_forage_fr = cur_th, daylight_h = 8, modelType = 21)
              }else if(model_type==31){
                env_func_3_1_par(days = 10, N= 100, th_forage_flr = cur_th, daylight_h = 8, modelType = 31)
              }else{
                print('problem with model_type settings')
              }
          out_per_run_list[j]<-cbind(output_env_func[[1]][1], cur_th)
...
```
### Now maek the functions for the x.3 models 
      ...
      for (i in 1:nrow(l1_grid)){
        ...
        # Run the model 25 times in the 12 environments and take the average
          for (j in 1:5){
            ...
            # Run the model 
              if(model_type==131){
                env_func_1_3_1_par(days = 10, N= 100, th_forage_sc1 = cur_th1 , th_forage_sc2 = cur_th2 , th_forage_sc3 = cur_th3, daylight_h = 8, modelType = 12)
              }else if(model_type==132){
                env_func_1_3_2_par(days = 10, N= 100, th_forage_sc1 = cur_th1 , th_forage_sc2 = cur_th2 , th_forage_sc3 = cur_th3, daylight_h = 8, modelType = 12)
              }else if(model_type==231){
                env_func_2_3_1_par(days = 10, N= 100, th_forage_fr1 = cur_th1 , th_forage_fr2 = cur_th2 , th_forage_fr3 = cur_th3, daylight_h = 8, modelType = 12)
              }else if(model_type==232){
                env_func_2_3_2_par(days = 10, N= 100, th_forage_fr1 = cur_th1 , th_forage_fr2 = cur_th2 , th_forage_fr3 = cur_th3, daylight_h = 8, modelType = 12)
              }else if(model_type==331){
                env_func_3_3_1_par(days = 10, N= 100, th_forage_flr1 = cur_th1 , th_forage_flr2 = cur_th2 , th_forage_flr3 = cur_th3, daylight_h = 8, modelType = 12)
              }else if(model_type==332){
                  env_func_3_3_2_par(days = 10, N= 100, th_forage_flr1 = cur_th1 , th_forage_flr2 = cur_th2 , th_forage_flr3 = cur_th3, daylight_h = 8, modelType = 12)
              }else{
                print('problem with model_type settings')
              }
