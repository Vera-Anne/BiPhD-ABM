...
level_2<-level_2[level_2$Var1>level_2$Var2,]
 ...
 tree_func_x2<-function(start_min_th1, start_max_th1, start_min_th2, start_max_th2, branch_num, depth){
      ...
      for (i in 1:depth){
        ...
        # Run the function to branch for the first th 
          out_th1<-as.data.frame(branch_func(range_min = start_min_th1, range_max = start_max_th1, branch_num = branch_num))
          out_th2<-as.data.frame(branch_func(range_min= start_min_th2, range_max = start_max_th2, branch_num = branch_num))
        # combine
          th_l1<-cbind(out_th1, out_th2)
          colnames(th_l1)<-c("th1", "th2")
        # Add the output 
          tree_output_list[[1]]<-th_l1
