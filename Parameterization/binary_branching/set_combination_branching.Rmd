...
out_sub2_x1<-tree_func_sub2_x1(start_min_v1_th1 = 0, start_max_v1_th1 = 0.4, start_min_v2_th1 = 0, start_max_v2_th1 = 4, branch_num = 4)
...
# Non hoarder 2 variables 
    tree_func_sub2_x2<-function(start_min_v1_th1, start_max_v1_th1, start_min_v2_th1, start_max_v2_th1, 
                                start_min_v1_th2, start_max_v1_th2, start_min_v2_th2, start_max_v2_th2,branch_num){
      depth<-3
      # Start the loop that will go thrugh the number of steps as set in 'depth' 
      for (i in 1:depth){
        # Generate a list for the output 
          if (i==1){
            ...
            # Subset this for cases 
                  grid<-grid%>%
                    filter(v1_th1>0 & v2_th1>0 & v1_th2>0 & v2_th2>0)%>%
...
out_sub2_x2<-tree_func_sub2_x2(start_min_v1_th1 = 0, 
                               start_max_v1_th1 = 0.4, 
                               start_min_v2_th1 = 0, 
                               start_max_v2_th1 = 4,  
                               start_min_v1_th2 = 0, 
