...
branching_output<-branch_4_optimization_x2_hpc(model_type = modelType, range_min_start_th1 = range_min_start_th1, range_max_start_th1 = range_max_start_th1, range_min_start_th2 = range_min_start_th2, range_max_start_th2 = range_max_start_th2)
