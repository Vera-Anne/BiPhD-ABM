...
if(next_level_chr=="level1"){
  ...
  # save it
   write.table(selected_df, file=paste0('th_HPC_sub', subset, "_x",  (str_sub(model_type, 2,2)), "_mod", 
                                        model_type, '_', next_level, '.csv'), row.names = F, col.names = F)
  ...
  selected_df<-tree_output_list[[next_level]][[paste(best_comb_chr)]]
   ...
   write.table(selected_df, file=paste0('th_HPC_sub', subset, "_x",  (str_sub(model_type, 2,2)), "_mod", 
    ...
    # save it
    write.table(selected_df, file=paste0('th_HPC_sub', subset, "_x",  (str_sub(model_type, 2,2)), "_mod", model_type, '_', next_level, '.csv'), row.names = F, col.names = F)
}
