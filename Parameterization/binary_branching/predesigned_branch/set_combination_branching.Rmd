    ...
    branch_func<-function(range_min, range_max, branch_num){
      ...
      if (branch_num==4){
        ...
        # Set the value for the threshold for each branch
          ...
          th_b3<-(th_b2+step_size)
          th_b4<-(th_b3+step_size)
          th_b5<-(th_b4+step_size)
          th_b6<-(th_b5+step_size)
...
out_sub1_x2<-tree_func_x2(model_type = 32, branch_num = 6)
```
...
```{r run branching subset 1 x.2, include=TRUE, message=F, warning=F}
out_sub1_x3<-tree_func_x3(model_type = 332, branch_num = 6)
```
...
```{r run subset 2 x1}
out_sub2_x1<-tree_func_sub2_x1(model_type=61, branch_num = 6)
```
...
out_sub2_x2<-tree_func_sub2_x2(model_type=62, branch_num = 6)
...
```{r run subset 2 x3}
out_sub2_x3<-tree_func_sub2_x3(model_type=631, branch_num = 4)
```
