...
out_sub1_x1<-tree_func_x1(model_type = 31, branch_num = 8)
```
x.2 
...
out_sub1_x2<-tree_func_x2(model_type = 32, branch_num = 8)
```
...
```{r run subset 2 x1}
out_sub2_x1<-tree_func_sub2_x1(model_type=61, branch_num = 8)
```
...
```{r run subset 2 x2}
out_sub2_x2<-tree_func_sub2_x2(model_type=62, branch_num = 8)
