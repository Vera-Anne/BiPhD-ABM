...
###############################
args<-c(5, 5, 8, 0.1, 0.2, 0.25, 2.0, 8, NA, NA)
...
th_forage_sc1 <- as.numeric(args[4])   # Threshold 1 = below this you retrieve 
th_forage_sc2<- as.numeric(args[5])    # Threshold 2 = below this you forage-eat
th_forage_sc3<- as.numeric(args[6])    # Threshold 3 = below this you you rest and above this you forage-hoard 
# Threshold fat-reserve below which you forage  (not relevant in model 1.1)
th_forage_fr <-as.numeric(args[7])
# Number of hours of daylight 
daylight_h <- as.numeric(args[8])
# array number
ar_num<- as.numeric(args[9])
# OUTPUT DIR
out_dir<-args[10]

##############################################################################
##   Model 1.3 direct-hoarder with 3 trhesholds based on stomach content  ##
##############################################################################
