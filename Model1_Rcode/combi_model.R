...
# TO DO URGENT 
    # check if mod 1.1 opt and beh loop function 
    # check if mod 1.2 opt and beh loop function 
    # check if mod 1.3 opt func works --> new: disregard wrong combinations of th1 and th2 
    # check if mod 1.3 opt loop and beh loop function 
    # check if mod 1.4 code works 
    # Consider merging opt loop and beh loop 
...
MOD_1_1_beh_loop_func<<-function(days, N, th_forage_fr, daylight_h, sim_type){
  ...
  for (i in 1:18){
    ...
    # GRAPHS TO SHOW THE FR AND SC TRAJECTORIES 
          # create a 
...
#################################################################        
    ...
    ###############################
      ...
      MOD_1_4_opt_thfr1_thfr2<-function(days, N, env_type, th_fr1_min, th_fr1_max, th_fr2_min, th_fr2_max, daylight_h, sim_type){
        ...
        # run it 
        MOD_1_4_opt_thfr1_thfr2(days = 30, N = 100, env_type = 9, th_fr1_min = 0, th_fr1_max = 4, th_fr2_min = 0, th_fr2_max = 4, daylight_h = daylight_h, sim_type = sim_type)
    ...
    ###########################################
      ...
      MOD_1_4_opt_loop_func<-function(days, N, th_fr1_min, th_fr1_max, th_fr2_min, th_fr2_max, daylight_h, sim_type){
        ...
        for (i in 1:18){
          ...
          mat_max_survival_th_sc1_fr2[i, 2]<<-cur_opt_th_fr2
