...
mainDir<-'C:/Users/c0070955/OneDrive - Newcastle University/1-PHD-project/Modelling/R/Figures/6-Model1_1'
setwd(mainDir)
...
Mod_1_1_stomC_function<-function(days, N, Tmax_range_low, Tmax_range_high, Tmin_range_low, Tmin_range_high, th_forage_sc, th_forage_fr, num_food_mean, prob_b_forage, b_prob, noplot, hoard_on, daylight_h){
    ...
    for (i in (1:N)){
      ...
      if(mat_alive[i,t]==0){
        ...
        if(dayOrNight==0){
          ...
          # In model 1_1 thre is one simple rule: it only depends on stomach content if the bird is eating 
          ...
          if ((mat_sc[i,t])<th_forage_sc) {
            ...
            # Note this won't happen in model 1_1 
            if(hoard_on=='1'){
...
Mod_1_2_fatR_function<-function(days, N, Tmax_range_low, Tmax_range_high, Tmin_range_low, Tmin_range_high, th_forage_sc, th_forage_fr, num_food_mean, prob_b_forage, b_prob, noplot, hoard_on, daylight_h){
...
Mod_1_1_stomC_function(days = 30, N = 100, Tmax_range_low = 2.5, Tmax_range_high = 5, Tmin_range_low = -5, Tmin_range_high = -2.5, th_forage_sc = 0.2, th_forage_fr = 1, num_food_mean = 3, prob_b_forage=0, b_prob=0, noplot = 0, hoard_on = 0, daylight_h = 6)

Mod_1_2_fatR_function(days = 30, N = 100, Tmax_range_low = 2.5, Tmax_range_high = 5, Tmin_range_low = -5, Tmin_range_high = -2.5, th_forage_sc = 0.2, th_forage_fr = 1, num_food_mean = 3, prob_b_forage=0, b_prob=0, noplot = 0, hoard_on = 0, daylight_h = 6)
